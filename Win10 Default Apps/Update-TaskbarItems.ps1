...
#
Pin-Taskbar -Item "C:\Program Files (x86)\Microsoft Office\root\Office16\outlook.exe" -Action Pin
Pin-Taskbar -Item "C:\Program Files (x86)\Microsoft Office\root\Office16\winword.exe" -Action Pin
