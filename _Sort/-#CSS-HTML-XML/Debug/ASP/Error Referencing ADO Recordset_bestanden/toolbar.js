...
if (ToolBar_Supported)
{
	...
	HTMLStr = 
		"<DIV ID='idToolbar' STYLE='background-color:white;width:100%;position:absolute;top:0;left:0;'>" +
		"<DIV ID='colorbar' STYLE='background-color:#003399;position:absolute;top:0;height:20;width:100%'></DIV>" +
		"<DIV ID='idRow1' STYLE='position:relative;height:20;'>" +
		"	<DIV ID='idICPBanner' STYLE='position:absolute;top:0;left:0;height:60;width:300;overflow:hidden;vertical-align:top;'><!--BEG_ICP_BANNER--><!--END_ICP_BANNER--></DIV>" +
		"	<DIV ID='idMSMenuCurve' STYLE='position:absolute;top:0;left:300;height:20;width:18;overflow:hidden;vertical-align:top;'><IMG SRC='/library/toolbar/images/curve.gif' BORDER=0></DIV>" +
		"	<DIV ID='idMSMenuPane' STYLE='position:absolute;top:0;left:300;height:20;width:10;background-color:black;float:right;' NOWRAP><!--MS_MENU_TITLES--></DIV>" + 
		"</DIV>" +
		"<DIV ID='idRow2' STYLE='position:relative;left:300;height:40;'>" +
		"	<DIV ID='idADSBanner' STYLE='background-color:#3366CC;position:absolute;top:0;left:0;height:40;width:200;vertical-align:top;overflow:hidden;'><!--BEG_ADS_BANNER--><!--END_ADS_BANNER--></DIV>" +
		"	<DIV ID='idMSCBanner' STYLE='background-color:#3366CC;position:absolute;top:0;left:200;height:40;width:112;vertical-align:top;overflow:hidden;' ALIGN=RIGHT><!--BEG_MSC_BANNER--><!--END_MSC_BANNER--></DIV>" +
		"</DIV>" +
...
if(document.getElementById) window.onresize = resizeToolbar;
if(document.getElementById) window.onload = resizeToolbar;

// The hard-coded numbers in functions - drawToolbar() & resizeToolbar()
// correspond to the dimension of the four gif files:
//		ICP_BANNER: 60h x 300w
...
function drawToolbar()
{
	...
	ToolbarMinWidth = (300+18) + MSMenuWidth;
...
{
	if(document.getElementById) calcsearchdivsizes();
	...
	if(ToolBar_Supported == false) return;
		...
		{	
			idMSMenuCurve.style.left  = (300+w);
			idMSMenuPane.style.left   = (300+w+18);
