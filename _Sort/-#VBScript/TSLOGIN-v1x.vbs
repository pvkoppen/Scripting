'VBScript:  Logon Script for Tui Ora Windows 2003 Terminal Servers
'Original Author:  Aaron.Gayton@staplestaranaki.co.nz
'Date Created   : 
'Date Modified  : 
...
If Not fs.FileExists("H:\Templates\Normal.dot") Then
       	fs.CopyFile "\\tol.local\sysvol\tol.LOCAL\scripts\normal.dot", "H:\Templates\Normal.dot", True
end if
