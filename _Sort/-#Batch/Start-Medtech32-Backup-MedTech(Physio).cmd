...
:General2
SET MT32_BackupFile=%MT32_BackupFolder%Physio.bak
...
REM --------------------------------------------------------
SET MT32_BackupFile=%MT32_BackupFolder%%strTime%-Physio.bak

REM Now we can start the Backup from Interbase using GBAK
REM --------------------------------------------------------
"%IB_ProgramFolder%bin\gbak.exe" -B -V -Z -USER sysdba -PAS masterkey -Y "%MT32_BackupFolder%%strTime%-physio.Log" "LocalHost:%MT32_InstallFolder%Data\physio.ib" "%MT32_BackupFile%"
