@ECHO OFF
REM Name          : Shutdown-ExchangeServer.cmd
REM Description   : Script used to Shutdown the Exchange Server (With a /silent option for scheduled operation).
...
REM Change Log.
REM -----------------------------------------------------------------------
REM 2011-09-14: 1.0: First published Edition
REM -----------------------------------------------------------------------
