@ECHO OFF
REM Name          : Restart-RDServer.cmd
REM Description   : Remote Desktop: Automated Weekly Restart.
...
REM 2013-10-23: v1.7: Silent run using /silent, otherwise ask: AreYouSure.
REM 2014-03-24: v1.8: Renamed to Restart-RDServer.
REM 2014-12-21: 2.0 New Structure
REM 2015-07-22: 2.0 New structure implemented
REM -----------------------------------------------------------------------

REM -- Default Settings
REM -----------------------------------------------------------------------
REM Scheduled to run: Every 1 weeks, on Sunday, at 3:05am, starting Today.
...
REM -----------------------------------------------------------------
"%SystemRoot%\System32\Shutdown.exe" /f /r /t 30 /c "Scheduled restart of RD Server to clear cache by batch: %~f0"
IF NOT %ERRORLEVEL%' == 0' SET strSendEmail=True
ECHO [INFO ] Completed.
GOTO DoEnd
