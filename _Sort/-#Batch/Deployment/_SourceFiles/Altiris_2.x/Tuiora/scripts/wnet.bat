...
set tools=f:\staples\tools
set ssst=f:\staples\tools\ssst
set sspath=f:\staples\cds\compaq\%ss%\%ssos%
set ospath=f:\staples\cds\windows\%os%
...
copy /y f:\Staples\CDS\altiris\aclient.exe c:\altiris\aclient
copy /y f:\Staples\CDS\altiris\aclient.inp c:\altiris\aclient
copy /y f:\Staples\CDS\altiris\sidgen.exe c:\altiris\aclient
copy /y f:\Staples\CDS\altiris\wlogev~1.exe c:\altiris\aclient
