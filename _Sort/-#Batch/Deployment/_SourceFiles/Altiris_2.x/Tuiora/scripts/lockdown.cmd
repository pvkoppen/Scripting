...
:: Microsoft Publisher
xcacls "%systemdrive%\Program Files\Microsoft Office\office\MSPUB.exe" /D "NT Authority\authenticated users" /y
xcacls "%systemdrive%\Program Files\Microsoft Office\office\MSPUB.exe" /c /t /g Administrators:F SYSTEM:F "iwayonline\Terminal Server Publisher Users:rx" /y

:: Microsoft Project
xcacls "%systemdrive%\Program Files\Microsoft Office\office\WINPROJ.exe" /D "NT Authority\authenticated users" /y
xcacls "%systemdrive%\Program Files\Microsoft Office\office\WINPROJ.exe" /c /t /g Administrators:F SYSTEM:F "iwayonline\Terminal Server Project Users :rx" /y

:: Microsoft Visio
xcacls "%systemdrive%\Program Files\Microsoft Visio" /D "NT Authority\authenticated users" /y
xcacls "%systemdrive%\Program Files\Microsoft Visio" /c /t /g Administrators:F SYSTEM:F "iwayonline\Terminal Server Visio Users:rx" /y
