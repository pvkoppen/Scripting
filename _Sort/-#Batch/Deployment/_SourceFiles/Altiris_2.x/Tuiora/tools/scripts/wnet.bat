...
set configs=f:\TUIORA\configs
set tools=f:\TUIORA\tools
set ssst=f:\TUIORA\tools\ssst
set sspath=f:\TUIORA\cds\compaq\%ss%\%ssos%
set ospath=f:\TUIORA\cds\windows\%os%
...
copy /y f:\Tuiora\cds\altiris\aclient.exe c:\altiris\aclient
copy /y f:\Tuiora\cds\altiris\aclient.inp c:\altiris\aclient
copy /y f:\Tuiora\cds\altiris\sidgen.exe c:\altiris\aclient
copy /y f:\Tuiora\cds\altiris\wlogev~1.exe c:\altiris\aclient
