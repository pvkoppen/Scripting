...
:: ==============================================================
:: rh73.bat
:: Red Hat 7.3 Scripted Install Script
::
:: Input:
...
set severity=1
set status="Red Hat Linux 7.3 Install: Started."
if exist f:\logevent.exe f:\logevent -l:%severity% -ss:%status%
goto done

:err1
set severity=3
set status="Red Hat Linux 7.3 Install: The NFSSERVER variable is not defined."
if exist f:\logevent.exe f:\logevent.exe -l:%severity% -ss:%status%
goto done

:err2
set severity=3
set status="Red Hat Linux 7.3 Install: The NFSSERVER variable is invalid. A valid NFS server address needs to be specified."
if exist f:\logevent.exe f:\logevent.exe -l:%severity% -ss:%status%
goto done

:err3
set severity=3
set status="Red Hat Linux 7.3 Install: The OS variable is not defined."
if exist f:\logevent.exe f:\logevent.exe -l:%severity% -ss:%status%
goto done

:err4
set severity=3
set status="Red Hat Linux 7.3 Install: The SS variable is not defined."
if exist f:\logevent.exe f:\logevent.exe -l:%severity% -ss:%status%
goto done

:err5
set severity=3
set status="Red Hat Linux 7.3 Install: The SS variable value is invalid."
if exist f:\logevent.exe f:\logevent.exe -l:%severity% -ss:%status%
goto done

:err6
set severity=3
set status="Red Hat Linux 7.3 Install: The KSFILE variable is not defined."
if exist f:\logevent.exe f:\logevent.exe -l:%severity% -ss:%status%
goto done

:err7
set severity=3
set status="Red Hat Linux 7.3 Install: The INITRDFILE variable is invalid."
if exist f:\logevent.exe f:\logevent.exe -l:%severity% -ss:%status%
goto done

:err8
set severity=3
set status="Red Hat Linux 7.3 Install: Format failed."
if exist f:\logevent.exe f:\logevent.exe -l:%severity% -ss:%status%
goto done
