...
F:\Resource.TOL\Deploy\TOOLS\SSST\ARRTYPE.EXE F:\Resource.TOL\Deploy\TOOLS\SSST\SSSTKARR.INI FIRST
IF ERRORLEVEL 1 GOTO ACR
GOTO END

:ACR
F:\Resource.TOL\Deploy\TOOLS\SSST\ACR.EXE /a %1 %2 %3 %4 %5 %6 %7 %8 %9
