REM Activity      : Install VMWare Server v1.0.1
...
REM -----------------------------------------------------------------
%USE_DRIVE%
REM cd "\_usr.lib\Software\VMWareServer_v1.0.1"
REM start /wait VMware-server-installer-1.0.1-29996.exe /s "/v/qn"
cd "\_usr.lib\Software\VMWareServer_v1.0.1\VMware-server-installer-1.0.1-29996"
start /wait MSIExec /i "VMware Server Standalone.msi"    /qn ADDLOCAL=ALL SERIALNUMBER=90XMD-YU86J-17305-4VKC8 /Lv* C:\Altiris\LogFiles\VMWareStandaloneServer.log
:start /wait MSIExec /i "VMware Server.msi"               /qn /Lv* C:\Altiris\LogFiles\VMWareServer.log
:start /wait MSIExec /i "VMware Management Interface.msi" /qn /Lv* C:\Altiris\LogFiles\VMWareManagement.log
:start /wait MSIExec /i "VMware VmCOM Scripting API.msi"  /qn /Lv* C:\Altiris\LogFiles\VMWareVmCOMScript.log
:start /wait MSIExec /i "VMware VmPerl Scripting API.msi" /qn /Lv* C:\Altiris\LogFiles\VMWareVmPerlScript.log
