REM Activity      : System: Allocate all additional disk space to a second partition.
...
REM -----------------------------------------------------------------
Label c: System
if exist "%USE_DRIVE%\_usr.lib\Configs\HP-DiskPart.txt" diskpart.exe /s "%USE_DRIVE%\_usr.lib\Configs\HP-DiskPart.txt"
if not exist d:\nul echo Y|format d: /fs:ntfs /v:Data
