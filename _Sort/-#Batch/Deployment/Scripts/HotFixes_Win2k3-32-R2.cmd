REM Activity      : Windows Server 2003 32 R2 Hotfixes script.
REM Created by    : Peter van Koppen
REM Company       : Tui Ora Limited
REM Date Created  : 2007-06-18
...
REM -----------------------------------------------------------------
%USE_DRIVE%
cd "\_usr.lib\Utilities\Patches\W52_32R2"
set PATHTO=%USE_DRIVE%\_usr.lib\Utilities\Patches\W52_32R2

REM Install the hotfixes
REM -----------------------------------------------------------------
REM --- Windows Server 2003 x86 SP2
start /wait %PATHTO%\WindowsServer2003-KB914961-SP2-x86-ENU.exe /Z /U
REM --- Windows Server 2003 x86 VSS Update
start /wait %PATHTO%\WindowsServer2003-KB940349-v3-x86-ENU.exe /Z /U
