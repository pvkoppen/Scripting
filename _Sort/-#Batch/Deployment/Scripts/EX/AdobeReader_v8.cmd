REM Activity      : Install Acrobat Reader v8.12
REM Created by    : Peter van Koppen
REM Company       : Tui Ora Limited
REM Date Created  : 2006-08-08
REM Date Changed  : 2008-05-07
REM Must be run as: As an Administrator
REM -----------------------------------------------------------------
...
REM -----------------------------------------------------------------
REM "%SystemRoot%\System32\change.exe" user /install
...
REM -----------------------------------------------------------------
%USE_DRIVE%
cd "\_usr.lib\Software\AdobeReader_v8"
start /wait AdbeRdr812_en_US /sPB /rs

REM Set this user session in Execute mode (For Terminal Servers Only)
REM -----------------------------------------------------------------
REM "%SystemRoot%\System32\change.exe" user /execute
