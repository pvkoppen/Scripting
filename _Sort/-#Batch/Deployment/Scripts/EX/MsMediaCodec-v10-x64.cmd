REM Activity      : Install Microsoft Media Codec Update v10
...
REM -----------------------------------------------------------------
%USE_DRIVE%
cd "\_usr.lib\Software\MsMediaCodec_v10"
start /wait windowsmedia10-kb917312-x64-intl.exe /passive /norestart /Log:C:\Altiris\LogFiles\WinMediaCodec-v10-64.log
