REM Activity      : Windows Server 2003 x64 R2 Hotfixes script.
...
REM -----------------------------------------------------------------
%USE_DRIVE%
cd "\_usr.lib\Utilities\Patches\W52_x64R2"
set PATHTO=%USE_DRIVE%\_usr.lib\Utilities\Patches\W52_x64R2

REM Install the hotfixes
REM -----------------------------------------------------------------
REM --- Windows Server 2003 x64 SP2
start /wait %PATHTO%\WindowsServer2003.WindowsXP-KB914961-SP2-x64-ENU.exe /Z /U
REM --- Windows Server 2003 x64 VSS Update
start /wait %PATHTO%\WindowsServer2003.WindowsXP-KB940349-v3-x64-ENU.exe /Z /U
