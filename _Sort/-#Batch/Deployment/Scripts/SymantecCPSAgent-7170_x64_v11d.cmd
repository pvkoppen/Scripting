REM Activity      : Install Symantec CPS Agent 7170 x64 v11d
...
REM -----------------------------------------------------------------
%USE_DRIVE%
cd "\_usr.lib\Software\SymantecCPSAgent-7170_v11d\CPSx64"
rem start /wait setup /AOFO: -s
ECHO ERR: CPS did not install!
