REM Activity      : Install Ms Windows Admin Tools v2003-sp1
REM Created by    : Peter van Koppen
REM Company       : Tui Ora Limited
REM Date Created  : 2007-01-24
...
REM -----------------------------------------------------------------
%USE_DRIVE%
cd "\_usr.lib\Software\MsWindowsAdminTools_v2003\WindowsServer2003-KB304718-AdministrationToolsPack
start /wait MSIExec /i adminpak.msi /qn /Lv* C:\Altiris\LogFiles\adminpak.log
