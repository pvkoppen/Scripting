' Activity      : Windows: Set IP address for: TOLGW01 (TOTS11)
' Created by    : Peter van Koppen
' Company       : Tui Ora Limited
' Date Created  : 2006-08-08
' Date Updated  : 2007-06-19
' Must be run as: <No Preference: Administrators/LocalSystem> -- A Domain Administrator?
' -----------------------------------------------------------------
...
' -----------------------------------------------------------------
strIPAddress     = Array("10.203.10.61")
