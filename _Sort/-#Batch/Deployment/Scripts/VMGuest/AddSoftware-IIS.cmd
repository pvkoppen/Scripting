REM Activity      : Install Windows Components: Internet Information Server (IIS)
...
REM -----------------------------------------------------------------
%USE_DRIVE%
cd "\_usr.lib\Configs\VMGuest"
start /wait sysocmgr.exe /i:%SystemRoot%\Inf\sysoc.inf /u:%USE_DRIVE%\_usr.lib\Configs\VMGuest\WNet_AddSoftware_IIS.txt /q
