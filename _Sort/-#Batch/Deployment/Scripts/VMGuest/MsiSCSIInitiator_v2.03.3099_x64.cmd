REM Activity      : Install Ms iSCSI Initiator v2.03.3099 x64
REM Created by    : Peter van Koppen
REM Company       : Tui Ora Limited
REM Date Created  : 2007-01-31
...
REM -----------------------------------------------------------------
%USE_DRIVE%
cd "\_usr.lib\Software\MsiSCSIInitiator_v2.03.3099"
start /wait Initiator-2.03-build3099-amd64fre.exe /Passive /Log:C:\Altiris\LogFiles\MsiSCSIInitiator.log
