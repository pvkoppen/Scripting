REM Activity      : Install Attache Prophet v1.9.0 ODBC
REM Created by    : Peter van Koppen
REM Company       : Tui Ora Limited
REM Date Created  : 2008-03-04
...
REM -----------------------------------------------------------------
%USE_DRIVE%
cd "\_usr.lib\Software\AttacheProphet_1.9.0\Setup\ODBC"
REM start /wait SETUP.EXE
CALL C:\Altiris\Tools\Sendmail.cmd "Altiris: Manualy install Attache Prophet ODBC on server: %ComputerName%" "%USE_DRIVE%\_usr.lib\Emails\TS\AttacheProphet_1.9.0.txt"
