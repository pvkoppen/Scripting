REM Activity      : Install Adobe Flash v9 (IE) & Adobe Shockwave v10.3
...
REM -----------------------------------------------------------------
%USE_DRIVE%
cd "\_usr.lib\Software\Adobe-Flash"
start /wait install_flash_player_active_x.exe /silent
cd "\_usr.lib\Software\Adobe-ShockWave"
start /wait sw_lic_full_installer.exe /s /v"/qn" 
