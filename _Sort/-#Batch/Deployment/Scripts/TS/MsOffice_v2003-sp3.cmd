REM Activity      : Update Ms Office 2003 with SP3 (todo)
...
REM -----------------------------------------------------------------
%USE_DRIVE%
cd "\_usr.lib\Software\MsOffice_v2003-SP3"
start /wait msiexec /passive /norestart /update mainsp3ff.msp /L*v C:\Altiris\LogFiles\MsOffice_v2003-sp3.log
