REM Activity      : Install Acrobat Reader v7
...
REM -----------------------------------------------------------------
%USE_DRIVE%
cd "\_usr.lib\Software\AdobeReader_v7\AdbeRdr70_enu_full"
start /wait msiexec /passive /norestart /i "Adobe Reader 7.0.msi"
...
REM -----------------------------------------------------------------
%USE_DRIVE%
cd "\_usr.lib\Software\AdobeReader_v7\Ac705RdP_efgj"
start /wait MSIexec /passive /norestart /update Ac705RdP_efgj.msp
IF EXIST C:\Altiris\Tools\aWait.exe C:\Altiris\Tools\aWait.exe 30 "Waiting for 1/2 minute(s) to finalize Installs/Updates. Seconds remaining: %%d"

REM Locate the installation folder and run the Install(s)
REM -----------------------------------------------------------------
%USE_DRIVE%
cd "\_usr.lib\Software\AdobeReader_v7\AdbeRdrUpd707_all_incr"
start /wait MSIexec /passive /norestart /update Rdr707.msp
IF EXIST C:\Altiris\Tools\aWait.exe C:\Altiris\Tools\aWait.exe 30 "Waiting for 1/2 minute(s) to finalize Installs/Updates. Seconds remaining: %%d"

REM Locate the installation folder and run the Install(s)
REM -----------------------------------------------------------------
%USE_DRIVE%
cd "\_usr.lib\Software\AdobeReader_v7\AdbeRdrUpd708_all_incr"
start /wait MSIexec /passive /norestart /update Rdr708.msp
IF EXIST C:\Altiris\Tools\aWait.exe C:\Altiris\Tools\aWait.exe 30 "Waiting for 1/2 minute(s) to finalize Installs/Updates. Seconds remaining: %%d"
