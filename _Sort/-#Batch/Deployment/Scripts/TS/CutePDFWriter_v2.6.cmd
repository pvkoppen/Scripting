REM Activity      : Install Cute PDF Writer v2.6
REM Created by    : Peter van Koppen
REM Company       : Tui Ora Limited
REM Date Created  : 2006-08-08
REM Must be run as: An Administrator (<No Preference: Administrators/LocalSystem>)
REM -----------------------------------------------------------------
...
REM -----------------------------------------------------------------
%USE_DRIVE%
cd "\_usr.lib\Software\CutePDFWriter"
rem start /wait CuteWriter_v2.6.exe
CALL C:\Altiris\Tools\Sendmail.cmd "Altiris: Manualy install CutePDFWriter v2.6 on server: %ComputerName%" "%USE_DRIVE%\_usr.lib\Emails\TS\CutePDFWriter_v2.6.txt"
