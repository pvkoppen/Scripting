REM Activity      : Install Windows 2003 Resource Kit: Delprof 
REM Created by    : Peter van Koppen
REM Company       : Tui Ora Limited
REM Date Created  : 2006-08-15
...
REM -----------------------------------------------------------------
%USE_DRIVE%
cd "\_usr.lib\Software\MsWindowsResourceKit_v2003"
start /wait MSIExec /qn /i delprof.msi /lv* c:\Altiris\LogFiles\win2k3-ResKit-DelProf.log
