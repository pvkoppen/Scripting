...
REM -----------------------------------------------------------------
%USE_DRIVE%
cd "\_usr.lib\Software\MsWindowsGroupPolicyTools_v2003"
start /wait MSIExec /i gpmc-sp1.msi /qn /Lv* C:\Altiris\LogFiles\GPMC-sp1.log
