REM Activity      : Install Ms Office 2003 Ent
...
REM -----------------------------------------------------------------
%USE_DRIVE%
cd "\_usr.lib\Software\MsOffice_v2003-Ent"
start /wait setup.exe TRANSFORMS="%USE_DRIVE%\_usr.lib\Software\MsOffice_v2003-Ent\Office.MST" /qb- /noreboot /L*v C:\Altiris\LogFiles\MsOffice_v2003-Ent.log
