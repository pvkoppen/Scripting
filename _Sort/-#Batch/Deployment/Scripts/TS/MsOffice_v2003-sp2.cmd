REM Activity      : Update Ms Office 2003 with SP2
...
REM -----------------------------------------------------------------
%USE_DRIVE%
cd "\_usr.lib\Software\MsOffice_v2003-SP2"
start /wait msiexec /passive /norestart /update mainsp2ff.msp /L*v C:\Altiris\LogFiles\MsOffice_v2003-sp2.log
