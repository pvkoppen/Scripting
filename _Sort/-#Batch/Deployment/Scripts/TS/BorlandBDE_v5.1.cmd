REM Activity      : Install Borland BDE v5.1
...
REM -----------------------------------------------------------------
%USE_DRIVE%
cd "\_usr.lib\Software\BorlandBDE_v5.0.1"
start /wait BDEUpd.exe /s /v"/qn"
copy /v /y PDOXUSRS.NET c:\PDOXUSRS.NET
C:\Altiris\Tools\xcacls.exe c:\PDOXUSRS.NET /y /c /t /G Everyone:RC
