...
CALL C:\Altiris\Tools\Sendmail.cmd "Altiris: Manualy install MailMarshal v2006 (r3) on server: %ComputerName%" "%USE_DRIVE%\_usr.lib\Emails\TS\MarshalMailMarshal_v2006-r3.txt"
