REM Activity      : Install Windows Components: Terminal Server (TS)
...
REM -----------------------------------------------------------------
%USE_DRIVE%
cd "\_usr.lib\Configs\TS"
start /wait sysocmgr.exe /i:%SystemRoot%\Inf\sysoc.inf /u:%USE_DRIVE%\_usr.lib\Configs\TS\WNet_AddSoftware_TS.txt /q
