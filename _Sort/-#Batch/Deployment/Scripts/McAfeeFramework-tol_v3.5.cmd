REM Activity      : Install Mcafee Antivirus Framework: TOL
...
REM -----------------------------------------------------------------
%USE_DRIVE%
cd "\_usr.lib\Software\McAfeeFramework-tol_v3.5"
start /wait FramePkg.exe /install=agent /silent
CALL C:\Altiris\Tools\Sendmail.cmd "Altiris: Check the McAfee Protection Pilot for server: %Computername%"
