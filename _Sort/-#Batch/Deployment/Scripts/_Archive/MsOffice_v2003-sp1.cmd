REM Activity      : Update Ms Office 2003 with SP1
...
REM -----------------------------------------------------------------
%USE_DRIVE%
cd "\_usr.lib\Software\MsOffice_v2003-SP1"
start /wait msiexec /passive /norestart /update mainsp1ff.msp /L*v C:\Altiris\LogFiles\MsOffice_v2003-sp1.log
