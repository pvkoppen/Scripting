REM Activity      : Activate the Winzip Instance v11 (Do not use!)
REM               : This version will stop working after the trial period, Use 9 instead.
REM Created by    : Peter van Koppen
REM Company       : Tui Ora Limited
REM Date Created  : 2006-12-05
...
start /wait winzip32.exe /noqp /noc4u /notip /AutoInstall

goto PastComment
REM -----------------------------------------------------------------
REM Winzip v9 Installation Options:
REM - /noqp= No Quick Pick
REM - /cleaninstall=??
REM -----------------------------------------------------------------
REM Winzip v10 Installation Options:
REM - /AutoInstall= Automated express install
REM - /noqp= No Quick Pick
REM - /noc4u= No Check For Update
REM - /notip= No "Tip OF The Day"
REM - /nopredefinedjobs= ..
REM - /nojobrunprompt= ..
REM - /nodesktop=
REM - /nostartmenu=
REM - /nomenugroup=
REM -----------------------------------------------------------------
REM Winzip v11 Installation Options:
REM -----------------------------------------------------------------
:PastComment 
