REM Activity      : Install Marshall MailMarshal Console 2006 r1
...
REM -----------------------------------------------------------------
%USE_DRIVE%
cd "\_usr.lib\Software\MarshalMailMarshal_v2006-r1\Intel"
REM start /wait setup /S /f1"%USE_DRIVE%\_usr.lib\Configs\TS\MailMarshal_v2006.iss"
CALL C:\Altiris\Tools\Sendmail.cmd "Altiris: Manualy install MailMarshal v2006 on server: %ComputerName%" "%USE_DRIVE%\_usr.lib\Emails\TS\MarshalMailMarshal_v2006-r1.txt"
