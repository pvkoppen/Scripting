REM Activity      : Install Adobe Shockwave & Flash Player v10.1
...
REM -----------------------------------------------------------------
%USE_DRIVE%
cd "\_usr.lib\Software\AdobeFlashShockwavePlayer_v10.1"
start /wait Shockwave_Installer_Full.exe /s /v"/qn"
