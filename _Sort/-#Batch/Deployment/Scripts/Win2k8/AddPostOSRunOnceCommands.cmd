REM Activity      : Add Post OS Installation RunOnce Commands Win2k8.
...
REM -----------------------------------------------------------------
REM echo REG IMPORT %%systemdrive%%\$oem$\TuiOra\AllowRDP.reg>>%HD%:\$oem$\runonce.cmd
REM echo REG IMPORT %%systemdrive%%\$oem$\TuiOra\NOPSSU.reg>>%HD%:\$oem$\runonce.cmd
