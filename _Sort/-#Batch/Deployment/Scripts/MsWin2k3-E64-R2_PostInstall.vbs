' Activity      : Win2k3 E64 R2: Set Registry settings
...
' -----------------------------------------------------------------
'--- x86
WSHShell.RegWrite "HKLM\SOFTWARE\Microsoft\Windows\CurrentVersion\Setup\SourcePath", "\\TOLDS01.tol.local\eXpress\lib\OSdist\W52E64R2.CD1", "REG_SZ"
...
'--- x64
WSHShell.RegWrite "HKLM\SOFTWARE\Wow6432Node\Microsoft\Windows\CurrentVersion\Setup\SourcePath", "\\TOLDS01.tol.local\eXpress\lib\OSdist\W52E64R2.CD1", "REG_SZ"
