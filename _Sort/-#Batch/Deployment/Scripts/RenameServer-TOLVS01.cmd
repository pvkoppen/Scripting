REM Activity      : Rename Server: TOLVS01 (TOVS02).
REM Created by    : Peter van Koppen
REM Company       : Tui Ora Limited
REM Date Created  : 2006-10-20
REM Must be run as: A Domain Administrator
REM -----------------------------------------------------------------
...
start /wait NETDOM RENAMECOMPUTER "%computername%" /newname:TOLVS01 /force
