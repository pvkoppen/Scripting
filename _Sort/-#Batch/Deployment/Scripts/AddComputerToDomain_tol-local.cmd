REM Activity      : Add Computer to Domain: TOL.local
REM Created by    : Peter van Koppen
REM Company       : Tui Ora Limited
REM Date Created  : 2006-12-13
...
REM Run NETDOM to add the local computer to the Domain
REM -----------------------------------------------------------------
%USE_DRIVE%
cd "\_usr.lib\Utilities\NetDom"
ping tol.local
NETDOM JOIN "%COMPUTERNAME%" /Domain:TOL.LOCAL /UserD:Administrator /PasswordD:Tu1@Ra30
