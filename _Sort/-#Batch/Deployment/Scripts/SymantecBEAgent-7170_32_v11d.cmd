REM Activity      : Install Symantec BE Agent 7170 32 v11d
...
REM -----------------------------------------------------------------
%USE_DRIVE%
cd "\_usr.lib\Software\SymantecBEAgent-7170_v11d\RAWS32"
REM CALL SetupAOFO.cmd
start /wait setup /AOFO: -s /CMS:TOLSS01.tol.local
