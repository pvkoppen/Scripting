@ECHO OFF
C:
FOR %%A IN (Public) DO CALL :ProcessUserFolder %%A AppData\Roaming\ "Apple Computer" "D:\Private\Joint\Redirected\Roaming-AppleComputer"
FOR %%A IN (Public) DO CALL :ProcessUserFolder %%A Music\ iTunes "D:\Media\Audio\iTunes"
