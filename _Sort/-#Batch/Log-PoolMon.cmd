@ECHO OFF
REM Name          : Log-PoolMon.cmd
REM Description   : Script used to create logfiles using PoolMon.
...
REM Change Log.
REM -----------------------------------------------------------------------
REM 2009-05-27: v1.0: First Edition
REM 2009-07-20: v1.0a: Updated date&time format.
REM -----------------------------------------------------------------------
...
POOLMON.exe -u -p -n "%~dp0LogFiles\%~n0.%strDateTime%.Log"
GOTO DoEnd
