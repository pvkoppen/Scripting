@ECHO OFF
REM Name          : Shutdown-SBSServer.cmd
REM Description   : Script used to Shutdown the SBS Server (With a /silent option for scheduled operation).
...
REM 2009-06-18: 1.1b: Reformat with new datestamp format
...
:AreYouSure
ECHO.
CHOICE /C YN /M "Are you sure you want to shutdown this server (%COMPUTERNAME%) ?"
...
"%SystemRoot%\System32\Shutdown.exe" /f /s /t 30 /c "System: Server shutdown by batch: %~f0"
IF NOT %ERRORLEVEL%' == 0' SET strSendEmail=True
GOTO DoEnd
