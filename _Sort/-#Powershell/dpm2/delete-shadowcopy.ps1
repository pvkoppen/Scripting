param([string] $replicaVolume)

if(!$args[0])
{
   if(!$replicaVolume)
   {
       $replicaVolume = read-host "ReplicaVolume:"
   }
   if(!$replicaVolume)
   {
...
else
{
    ...
    {
        write-host Usage::
        write-host Delete-Shadowcopy.ps1 -ReplicaVolume [Replica volume name]
        write-host Help::
        write-host -deletes all shadow copies on a volume.
        write-host 
        exit 0
    }
    else
...
$replicaVolume = $replicaVolume.Trim();
...
if ($sclist)
{
    ...
    {
        if($sc.VolumeName -eq $replicaVolume)
        {
            $sc.Delete()
            $deleted ++;
        }
...
if($deleted -eq 0)
{
    write-host ("Could not find shadow copies on replica volume {0}. Zero shadow copies deleted." -f $replicaVolume) -ForeGroundColor Red
}
else
{
    write-host ("Deleted {0} shadow copies(s)." -f $deleted) -ForeGroundColor Green
}
exit
# SIG # Begin signature block
# MIIbdgYJKoZIhvcNAQcCoIIbZzCCG2MCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUP9BKDqjl/A6jymy5ZA1MlFHG
# qmWgghYqMIIEEjCCAvqgAwIBAgIPAMEAizw8iBHRPvZj7N9AMA0GCSqGSIb3DQEB
...
# KoZIhvcNAQkEMRYEFAFOETcIK/7DjkBiE7KmXGxvH3pfMIGABgorBgEEAYI3AgEM
...
# d3cubWljcm9zb2Z0LmNvbS9EUE0wDQYJKoZIhvcNAQEBBQAEggEAMWAQDnRlrSNt
# JaVCjy+5OEqShpWn45QvV3ltXkruHzAmikWjy2tbn9SaFuk659FrvxfPqG++do4T
# s/xc3V4vv49qx+EhSB6iMB6IzVcDmLb7fLs5Uc1nQrDw4BKhzsaWoF7LKp2q/DLm
# fLDyibNkf+Wear9SjywVtDxFLZInYi5BkgJy14SR8x3d+SFO2RmMnqtfOUYhBsgI
# z7UyKd6UH7twoUEzCkRfD8SZzMK0mDQ7QdnexFF8X0XrQh1AJSCdD7dS49GLXtSX
# zvEmluLKzZxxeXDII1yRhctS5b594LYz1/+8D/cgNmusWrrD7ix6eZJZGOj3D17B
# PiRveDId0aGCAh8wggIbBgkqhkiG9w0BCQYxggIMMIICCAIBATCBhzB5MQswCQYD
...
# SIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTA4MTIwOTAwNDQz
# MVowIwYJKoZIhvcNAQkEMRYEFD5sgJI0VU5jcB/QoIQ88utBTpNCMA0GCSqGSIb3
# DQEBBQUABIIBAG9tPrSGkJNXMxsFY7n7RQGl7bk7KQOcva19UtTc2cB8iHp/hgju
# VyQRBF5DJeZlck8K4Dvh0thXhRiM6BrQtOSEXed46kDAqu3ps5PYT797nGa9JDzW
# w4eAraOy/fIPXCRbZcF0Zi8/PzFZPf2x84jNoFxo65x0PJA8sShF7j22NNZfQKUm
# kGL7F2cANZZOXSrz5vM807tfEruWmdaisWpT5xxX7+YNWu2lvO4LsXC2dbltt4w2
# NwynzUfAs1IssNqMqclWmh3Wqz0zhYBsV27k/RFqqggTK+kiEuKo+fD5dEoR/TRN
# 41RFmVCI+YdXmdkqDCMqY08vUw2SHSrj83U=
