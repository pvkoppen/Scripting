# Script to list ExchangeSCRProtection enabled protected computers
...
if(("-?","-help") -contains $args[0])
{
   write-host 
   write-host "Usage::"
   write-host "`tGet-ExchangeSCRProtection.ps1 <DPMServerName>" 
   write-host 
   exit 0;
}
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUKXrtGYDmv89QFI/DkDSIEQsy
# xG2gghYqMIIEEjCCAvqgAwIBAgIPAMEAizw8iBHRPvZj7N9AMA0GCSqGSIb3DQEB
...
# KoZIhvcNAQkEMRYEFMy/HN0EcjdBEi2AgaKbgBTDuT0dMIGABgorBgEEAYI3AgEM
...
# d3cubWljcm9zb2Z0LmNvbS9EUE0wDQYJKoZIhvcNAQEBBQAEggEAS1Q471OLT/Xr
# +R1VC673nSXRCKEfurYgKEfUMog8W3ySGmSA5Hgv/hUZn8HLqSVxbvRrNOIyXNtj
# iqCR33w+LIfiUNcUcU6UiswYsdP7ZjCal7moPRXVn7TVWPXyRIArZEUbXFKyOg7T
# DXhtKStzQICc2XW4n+dLaCoIhLltahnpaWhBZBc5z6nwwVQK5OWvWTO2Spa7Vp7Z
# LM2WwHybrxWfgpwjIPqL4KPrpSNVAYTRNoAZD268VH0grv62VGs6MbtPWgTac0w0
# W9dozAibwjRqiLG7nP+7sz9cwUSC3dISbMHgkCAjieNxPVia4KUOap/vAxPvnMB3
# a67hKfFt0aGCAh8wggIbBgkqhkiG9w0BCQYxggIMMIICCAIBATCBhzB5MQswCQYD
...
# SIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTA4MTIwOTAwNDUz
# MVowIwYJKoZIhvcNAQkEMRYEFDk28aiZ85RqSszH/O5ml5oU43REMA0GCSqGSIb3
# DQEBBQUABIIBAIbu+og2Wq3njFztkbp6EM6FKU3QJkESO9hPukV9DD9wudM2SQx0
# scssUTaddG+GoP40/TQH94AmJMV5vXeLjjKPvX36dzOEB1xRjm9I7YfP225xSRSc
# +m60N0/vZKxwGL5gULmCrvQa9AAuPfRB7J/mWwhWn7mzEugnBaA6YgcDag8RySmY
# 4qotIjBCRNPAfSfG/8VKnsHdH3gmlHyVvzaMuhr9VfIn1uoZ0+6sxVcpHiFWtLmk
# AdzRqFtco2pxEbZfZOqlxZeNEteb7BErU/Izun1zsBmtXAoBW0S0I9GTdZUkt6ad
# 8beA0jYq139l6tKI9FjE+K/EsEFPgEmxvSQ=
