...
Write-Host "# List all Libraries..." -foregroundcolor $colorHeader
  ...
  $DPMLibraries 
#| ft UserFriendlyName,Type


#Write-Host "# List all Libraries which are AutoLoaders." -foregroundcolor $colorHeader
#  $DPMLibrary = $DPMLibraries | Where-Object -FilterScript {$_.Type -eq "TapeLibrary"} 
#  $DPMLibrary 
#| ft UserFriendlyName,Type
