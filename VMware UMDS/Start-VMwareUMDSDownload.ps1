...
$strStoreFolder  ='D:\Volatile\VMware\VMware Update Manager\Data'

#Config
<#
# ConfiguredURLs
. "$strInstallFolder\vmware-umds.exe" -S -u "https://umds.methanex.com/patch-store/hostupdate/__hostupdate20-consolidated-index__.xml" -r HOST
#. "$strInstallFolder\vmware-umds.exe" -S -l "https://umds.methanex.com/patch-store/hostupdate/__hostupdate20-consolidated-index__.xml"
# PatchStore
. "$strInstallFolder\vmware-umds.exe" -S -P "$strStoreFolder\Data\"
# HostVersions
. "$strInstallFolder\vmware-umds.exe" -S --disable-host
. "$strInstallFolder\vmware-umds.exe" -S -e embeddedEsx-6.5.0
. "$strInstallFolder\vmware-umds.exe" -S -e embeddedEsx-6.7.0
#. "$strInstallFolder\vmware-umds.exe" -S -e embeddedEsx-7.0.0
#>

#Actions
. "$strInstallFolder\vmware-umds.exe" -G
. "$strInstallFolder\vmware-umds.exe" -D 2>&1
